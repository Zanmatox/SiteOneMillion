                ...
                <div class="w-100">
                    <p> Apperçu de la page</p> 
                        <div style="border: solid 2px orangered;">
                            <p>
                                <img src="img/redsquare.png" class="smallsquares" alt="">
                                    emplacements indisponibles
                            </p>
                            <!-- carré rouge -->
                            <p> 
                                <img src="img/greysquare1.jpg" class="smallsquares" alt="">
                                    emplacements disponibles
                            </p>
                            <!-- carré gris -->
                            <p> 
                                <img src="img/white square.jpg" class="border border-warning smallsquares" alt="">
                                    emplacements à forte demande
                            </p>
                            <!-- carré vide jaune -->
                            <p> 
                                <img src="img/blue square.svg" class="smallsquares" alt=""> 
                                    votre emplacement
                            </p>
                            <!-- carré bleu -->
                            </div>
